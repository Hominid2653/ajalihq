...
| 2026-08-25 | Phase 2a auth: `POST /api/auth/register`, `POST /api/auth/login`, `GET /api/auth/me` + JWT role claims. Demo users seeded. Next: Phase 3 read APIs / incident CRUD. |
